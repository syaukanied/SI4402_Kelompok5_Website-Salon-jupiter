  ...
  .testimonial-slider-wrap .tns-nav {
    ...
    <main>
            ...
            <div class="content container">
                ...
                <div class="video">
                    <a href="https://www.youtube.com/channel/UCezsa47t6KPsUOzpfGGgHzA">
                        <button class="btn btn-video">VIDEO</button>
                    </a>
                </div>
            </div>
        </section>
        ...
        <section id="ourService" class="our-service">
            <img class="bg" src="/assets/images/ser.svg" alt="">
            <div class="content container">
        ...
        <section id="ourArtist" class="our-artist">
            <div class="content container">
                <h2 class="text-center">OUR HAIR ARTIST</h2>
        ...
        <section id="aboutUs" class="about">
            <img class="bg" src="/assets/images/about.svg" alt="">
            <div class="content container">
            </div>
            <img class="about-img" src="/assets/images/aboutus.png" alt="">
        </section>
        <!-- CONTACT US -->
    </main>
